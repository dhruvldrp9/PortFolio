  ...
  return (
    <div className="bg-background min-h-screen">
      <div className="container mx-auto px-2 sm:px-4 py-10 sm:py-16">
        ...
        />
        <div className="relative mt-12 sm:mt-24 flex flex-col items-center">
          ...
          <div className="w-full max-w-9xl flex flex-col gap-10 sm:gap-20 z-10 px-1 sm:px-2 md:px-8">
            {education.map((edu, idx) => (
              <div key={edu.id} className="relative flex min-h-[180px] sm:min-h-[220px]">
                ...
                <div className={`w-full md:w-1/2 ${idx % 2 === 0 ? 'md:ml-auto md:pl-8 sm:md:pl-16' : 'md:mr-auto md:pr-8 sm:md:pr-16'} z-10`}> 
                  <TimelineItem
