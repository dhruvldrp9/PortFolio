...
import { ArrowRight, ChevronRight, Code } from "lucide-react";
import BlogCard from "@/components/blog/blog-card";
import ProjectCard from "@/components/projects/project-card";
          ...
          <div className="container mx-auto px-4 relative z-10">
            <div className="max-w-4xl mx-auto text-center pt-20 pb-16">
              <motion.h1
                ...
                transition={{ duration: 0.5 }}
              >
                Building the Future with AI & Cybersecurity
              </motion.h1>
              <motion.p
                ...
                transition={{ duration: 0.5, delay: 0.2 }}
              >
                Innovative solutions at the intersection of artificial intelligence and cybersecurity
                ...
                <div>
                  ...
                  >
                    ...
                    <ProjectCard
                      ...
                      description="Real-time threat detection system using machine learning algorithms."
                      tags={["AI", "Python", "TensorFlow"]}
                      imageUrl="/attached_assets/image_1740931672312.png"
                      link="/projects/1"
                    />
                    <ProjectCard
                      title="Secure Cloud Infrastructure"
                      description="Scalable and secure cloud architecture with automated security controls."
                      tags={["AWS", "IaC", "DevSecOps"]}
                      imageUrl="/attached_assets/image_1740931685060.png"
                      link="/projects/2"
                    />
                    <ProjectCard
                      title="Blockchain Identity Verification"
                      description="Decentralized identity verification using blockchain technology."
                      tags={["Blockchain", "Smart Contracts", "Identity"]}
                      imageUrl="/attached_assets/image_1740932581102.png"
                      link="/projects/3"
                    />
                  </motion.div>
                </div>
